...
* http://jqueryui.com
* Includes: core.js, widget.js, mouse.js, position.js, draggable.js, resizable.js, button.js, dialog.js, menu.js, selectmenu.js, effect.js, effect-drop.js
...
(function (t) {
        ...
        t.position = {
            ...
            return b = s(y), y[0].preventDefault && (n.at = "left top"), g = b.width, m = b.height, _ = b.offset, v = t.extend({}, _), t.each(["my", "at"], function () {
                ...
                var s, h, c = t(this), u = c.outerWidth(), d = c.outerHeight(), f = i(this, "marginLeft"),
                    ...
                    T = d + b + i(this, "marginBottom") + k.height, M = t.extend({}, v),
                    I = e(C.my, c.outerWidth(), c.outerHeight());
                "right" === n.my[0] ? M.left -= u : "center" === n.my[0] && (M.left -= u / 2), "bottom" === n.my[1] ? M.top -= d : "center" === n.my[1] && (M.top -= d / 2), M.left += I[0], M.top += I[1], o || (M.left = l(M.left), M.top = l(M.top)), s = {
                    marginLeft: f,
                    marginTop: b
                }, t.each(["left", "top"], function (e, i) {
                    t.ui.position[x[e]] && t.ui.position[x[e]][i](M, {
                        targetWidth: g,
                        targetHeight: m,
                        elemWidth: u,
                        elemHeight: d,
                    ...
                    var e = _.left - M.left, i = e + g - u, s = _.top - M.top, o = s + m - d, l = {
    ...
    var a, r = "ui-button ui-widget ui-state-default ui-corner-all",
    ...
    t.widget("ui.button", {
        ...
        _create: function () {
            ...
            null === i.label && (i.label = "input" === this.type ? this.buttonElement.val() : this.buttonElement.html()), this._hoverable(this.buttonElement), this.buttonElement.addClass(r).attr("role", "button").bind("mouseenter" + this.eventNamespace, function () {
                ...
                return i.disabled ? !1 : (t(this).addClass("ui-state-active"), a = this, e.document.one("mouseup", function () {
                    a = null
                }), void 0)
            }).bind("mouseup" + this.eventNamespace, function () {
                return i.disabled ? !1 : (t(this).removeClass("ui-state-active"), void 0)
            }).bind("keydown" + this.eventNamespace, function (e) {
                return i.disabled ? !1 : ((e.keyCode === t.ui.keyCode.SPACE || e.keyCode === t.ui.keyCode.ENTER) && t(this).addClass("ui-state-active"), void 0)
        ...
        _setOption: function (t, e) {
            return this._super(t, e), "disabled" === t ? (this.widget().toggleClass("ui-state-disabled", !!e), this.element.prop("disabled", !!e), e && ("checkbox" === this.type || "radio" === this.type ? this.buttonElement.removeClass("ui-state-focus") : this.buttonElement.removeClass("ui-state-focus ui-state-active")), void 0) : (this._resetButton(), void 0)
        },
        refresh: function () {
        ...
        open: function () {
            var e = this;
            return this._isOpen ? (this._moveToTop() && this._focusTabbable(), void 0) : (this._isOpen = !0, this.opener = t(this.document[0].activeElement), this._size(), this._position(), this._createOverlay(), this._moveToTop(null, !0), this.overlay && this.overlay.css("z-index", this.uiDialog.css("z-index") - 1), this._show(this.uiDialog, this.options.show, function () {
    ...
    t.effects = {effect: {}}, function (t, e) {
        ...
        t.extend(t.effects, {
            version: "1.11.4", save: function (t, e) {
                for (var i = 0; e.length > i; i++) null !== e[i] && t.data(u + e[i], t[0].style[e[i]])
            }, restore: function (t, e) {
                var i, s;
                for (s = 0; e.length > s; s++) null !== e[s] && (i = t.data(u + e[s]), void 0 === i && (i = ""), t.css(e[s], i))
    ...
    }(), t.effects, t.effects.effect.drop = function (e, i) {
